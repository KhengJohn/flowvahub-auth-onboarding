...
export function AuthForms() {
  ...
  return (
    <div className="relative w-full max-w-[420px] overflow-hidden rounded-[var(--radius-lg)] bg-white p-10 shadow-[var(--shadow-md)]">
      <div className="absolute left-0 top-0 h-[6px] w-full bg-gradient-to-r from-primary to-accent"></div>

      {/* Logo */}
      <div className="mb-8 flex items-center justify-center text-2xl font-bold text-primary">
